  ...
  "5": {
    ...
    2: {
      theory: `
        ...
        <p>Основные правила и случаи употребления:</p>
        <ul>
          <li>Действия, которые произошли в прошлом и уже закончились</li>
          <li>Последовательность действий в прошлом</li>
          <li>Образование: правильные глаголы + -ed, неправильные глаголы - 2-я форма</li>
        </ul>
      `,
      examples: [
        {
    ...
    3: {
      theory: `
        ...
        <ul>
          ...
          <li>Спонтанные решения</li>
          <li>Обещания, предложения, просьбы</li>
          <li>Образование: will + инфинитив без to</li>
        </ul>
      `,
      examples: [
        {
  ...
  "6": {
    0: {
      theory: `
        ...
        <p>Основные правила и случаи употребления:</p>
        <ul>
          <li>Действия, которые произошли в прошлом, но связаны с настоящим</li>
          <li>Опыт в жизни (без указания когда именно)</li>
          <li>Недавно завершившиеся действия</li>
          <li>Образование: have/has + Past Participle (3-я форма глагола)</li>
        </ul>
      `,
      examples: [
        {
          problem: "Как образуется Present Perfect?",
          solution: "Утвердительная форма:\n1) I have played tennis. - Я (уже) играл в теннис.\n2) She has gone to school. - Она ушла в школу (и еще не вернулась).\n\nОтрицательная форма:\n1) I have not (haven't) played tennis. - Я не играл в теннис.\n2) She has not (hasn't) gone to school. - Она не ушла в школу.\n\nВопросительная форма:\n1) Have you played tennis? - Ты играл в теннис?\n2) Has she gone to school? - Она ушла в школу?"
        }
      ],
      exercises: [
        {
