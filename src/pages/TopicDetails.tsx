...
const topics: Record<string, Record<string, Record<number, TopicContent>>> = {
  ...
  mathematics: {
    "5": {
      ...
      2: {
        theory: `
          ...
          <ul>
            ...
            <li>Треугольник и его виды</li>
            <li>Прямоугольник, квадрат, окружность</li>
          </ul>
        `,
        examples: [
          {
            problem: "Найдите периметр прямоугольника со сторонами 5 см и 3 см",
            solution: "1) P = 2(a + b)\n2) P = 2(5 + 3)\n3) P = 2 × 8\n4) P = 16 см"
          }
        ],
        exercises: [
      ...
      3: {
        theory: `
          <h2>Измерение величин</h2>
          <p>Единицы измерения различных величин.</p>
          <p>Основные величины:</p>
          <ul>
            <li>Длина (мм, см, м, км)</li>
            <li>Масса (г, кг, т)</li>
            <li>Время (с, мин, ч)</li>
            <li>Площадь (см², м², км²)</li>
          </ul>
        `,
        examples: [
          {
            problem: "Выразите 3 км 200 м в метрах",
            solution: "1) 1 км = 1000 м\n2) 3 км = 3000 м\n3) 3000 м + 200 м = 3200 м"
          }
        ],
        exercises: [
          {
            problem: "Переведите:\n1) 2 км 500 м в метры\n2) 3600 секунд в часы",
            answer: "1) 2500 м\n2) 1 час"
          }
        ]
      }
    ...
    "6": {
      0: {
        theory: `
          ...
          <p>Правила делимости натуральных чисел.</p>
          <p>Основные понятия:</p>
          <ul>
        ...
        examples: [
          {
            problem: "Найдите НОД чисел 24 и 36",
            solution: "1) Раскладываем на множители:\n24 = 2³ × 3\n36 = 2² × 3²\n2) НОД = 2² × 3 = 12"
          }
        ],
        exercises: [
          {
            problem: "Найдите:\n1) НОД(18, 24)\n2) НОК(12, 18)",
            answer: "1) НОД(18, 24) = 6\n2) НОК(12, 18) = 36"
          }
        ]
      }
    }
